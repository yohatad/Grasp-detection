...
from tools.dataset_processing import image


class ImageData:
    """
    Dataset wrapper for the Image data.
    """
    def __init__(self, width=640, height=480, output_size= 480, include_depth=True, include_rgb=True):
        ...
        if include_depth is False and include_rgb is False:
            raise ValueError('Depth or RGB must be given.')
